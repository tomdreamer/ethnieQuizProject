questions =[
   {
    ...
    question11 ={
        ...
        // responseB: ,
        // responseC: ,
        desription : "Les Samis (aussi désignés sous le nom de Lapons) sont un peuple autochtone d'une zone qui couvre le nord de la Suède, de la Norvège et de la Finlande ainsi que la péninsule de Kola en Russie connue sous le nom de Laponie. Leur nom, Saami dans leur propre langue, est également parfois écrit « Sámi », « Sames », « Samés » ou encore « Sâmes ». Les samis parlent des langues sames. Ce peuple est souvent nommé « Lapons » mais ce terme est non seulement un terme étranger mais aussi originellement péjoratif, issu de la racine lapp qui signifie porteur de haillons en suédois3. De même, ils appellent leurs terres ancestrales Sápmi et non Laponie. Les activités traditionnelles des Samis étaient autrefois la pêche et l'élevage de rennes, mais aujourd'hui seule une minorité des 85 000 Sames en vit encore. ",
    },
    question12 ={
        question : "Where does this ethnie come's from?",
        nameEthnie : "Yi",
        pays : "Chine",
        picture : "./images/yi.jpg",
        // longitudeA: ,
        // latitudeA: ,
        // longitudeB: ,
        // latitudeB: ,
        ...
        // responseB: ,
        // responseC: ,
        desription : "Les Yi sont un peuple tibéto-birman majeur de la Chine du Sud, établi en grande majorité au Yunnan et dans la région des Da Liangshan, au Sud du Yunnan, avec quelques poches au Guangxi et au Nord Vietnam. Nous traversons au cours de cette étape les Da Liangshan, c’est à dire les « Grandes Montagnes Froides », région de montagnes isolées, que contourne le grand fleuve Yangtsé avant d’aller s’étaler dans les grandes plaines du Sichuan, qui n’est pratiquement jamais proposée dans des parcours de Tour Operators. Cette région abrite une importante population Yi, autrefois connue sous le nom générique de Lolo, notamment par des explorateurs Français du début du 20ème siècle, dont le commandant d’Ollone, qui leur a consacré un ouvrage intitulé « Les derniers barbares ».",
    },
    question13 ={
        question : "Where does this ethnie come's from?",
        nameEthnie : "Inuit",
        ...
        // responseB: ,
        // responseC: ,
        desription : "Les Inuits sont un groupe de peuples autochtones partageant des similarités culturelles et une origine ethnique commune vivant dans les régions arctiques de l'Amérique du Nord. Il y a environ 150 000 Inuits vivant au Groenland, au Canada et aux États-Unis. Bien que le Conseil circumpolaire inuit regroupe également les Yupiks de l'Alaska et de la Sibérie, ceux-ci ne sont pas des Inuits dans le sens d'une descendance thuléenne. Les Inuits ne sont pas considérés comme des Amérindiens puisque leurs ancêtres seraient venus en Amérique plusieurs millénaires après l'arrivée des Paléoasiatiques, les ancêtres des Amérindiens4. En fait, les Inuits sont davantage similaires aux peuples habitant les régions arctiques asiatiques qu'aux peuples amérindiens5. Il ne faut pas non plus confondre les Inuits avec les Innus qui sont un peuple amérindien vivant dans la forêt boréale canadienne du Nord-Est du Québec et du Labrador. Historiquement, les Inuits étaient un peuple de chasseurs nomades. De nos jours, si la plupart des Inuits sont devenus sédentaires, une grande partie vit encore de la chasse et de la pêche. ",
    },
    question14 ={
        question : "Where does this ethnie come's from?",
        nameEthnie : "Hani",
    ...
    question15 ={
        ...
        // responseB: ,
        // responseC: ,
        desription : "Pour les indigènes vivant dans la Sierra Nevada de Santa Marta, ces montagnes représentent le cœur du monde. Ainsi, la Sierra Nevada de San Marta maintient l'équilibre spirituel et écologique de toute la planète. La mythologie des Indiens Kogis conte qu'ils sont les frères aînés de l'humanité. Les étrangers, en particulier ceux d'Occident, sont appelés les petits frères. La légende veut que ces petits frères aient été bannis, autrefois, du cœur du monde à cause des infractions qu'ils ont commises. Ils doivent donc poursuivre leur route et subir les châtiments de leurs méfaits12. Leurs rituels et traditions sont caractérisés par un rapport très fort et très sensitif à la Terre. Ils se sentent encore de nos jours « gardiens de la Terre » qu'ils considèrent et traitent comme « sacrée ». Ils sont capables, selon leurs dires, de percevoir les lieux où la Terre est « vivante » et ceux où elle est morte.",
    },
    ]
